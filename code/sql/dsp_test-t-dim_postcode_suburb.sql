...
/*
  ...
  DROP TABLE IF EXISTS dim_postcode_suburb
*/
CREATE TABLE dim_postcode_suburb (
	dim_postcode_suburb_key int(11) NOT NULL AUTO_INCREMENT
	...
	,CONSTRAINT dim_postcode_suburb_pk PRIMARY KEY (dim_postcode_suburb_key)
)
;
INSERT INTO dim_postcode_suburb (postcode, suburb, state, latitude, longitude) VALUES
...
;
select * from dim_postcode_suburb
;
